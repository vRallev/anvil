...
The generated code for the factory looks like this when using Anvil:
```kotlin
// Generated by com.squareup.anvil.compiler.AnvilComponentRegistrar
...
public object AppModule_ProvideTypeFactory : Factory<ParentType> {
  public override fun `get`(): ParentType = provideType()

  @JvmStatic
  public fun create(): AppModule_ProvideTypeFactory = this

  @JvmStatic
  public fun provideType(): ParentType = Preconditions.checkNotNull(AppModule.provideType(),
